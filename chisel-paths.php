...
return [
    ...
    // This kit manages passkeys via PasskeyManager.vue and
    // SignInWithPasskeyButton.vue, which chisel.php already deletes
    // directly when the passkeys feature is disabled.
    'passkey_files' => [],
];
